...
function About(): JSX.Element {
  return <Page title="About me">
    ...
    <p>I work for Wild Me, an organization that builds open source software for conservation research. In the past I worked for a company that makes networking gear, a robotics cinematography startup, and even the Federal Reserve Board of Governors.</p>
